...
public class Loan extends Book {
	...
	private java.sql.Timestamp requested_at = null;

	private User user;


	public void setLoan( User user,String bookReference, java.sql.Timestamp loanDate, java.sql.Timestamp returnDate, java.sql.Timestamp expectedReturnDate,java.sql.Timestamp requestedAt){
		this.user = user;
